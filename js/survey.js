...
const RESULTS = {
  ...
  T1: {
    ...
    detail: `<p>전입학을 위해서는 부·모·자녀 전 가족의 실거주 및 주민등록 이전과 부모님 중에 한 분이 세대주가 되어야 합니다.</p>
  ...
  T3: {
    ...
    detail: `<p>과학고, 외국어고, 국제고, 영재고, 자율형 사립고는 일반적인 전입학 규정이 적용되지 않습니다.</p>
      <ul>
        <li>학교 소재지 1년 거주 후 학교장 허가 시 가능</li>
        <li>충남 외 타시도로 전 가족 이전 시 가능한 경우 있음</li>
  ...
  T4: {
    ...
    label: '조건부 가능',
    icon: '⚠',
    title: '아산 전학 — 현 학교 소재지에서 전 가족 6개월 이상 거주 필요',
    detail: `<p>충남 내 타시군 학교에서 아산으로 전학을 원하시는 경우, 거주 기간 조건이 있습니다.</p>
      <ul>
        <li>현 학교 소재지에서 <strong>6개월 이상 거주</strong>한 경우 전입학 가능</li>
        <li>일반계 고등학교와 특성화고등학교 간: 2학년 1학기까지 전입학 가능</li>
        <li>일반계 고등학교 끼리는 3학년 1학기까지 전입학 가능</li>
  ...
  T5: {
    ...
    label: '조건부 가능',
    icon: '⚠',
    title: '천안 전학 — 현 학교 소재지에서 전 가족 6개월 이상 거주 필요',
  ...
  T6: {
    ...
    label: '조건부 가능',
    icon: '⚠',
    title: '아산 전학 — 전 가족이 아산에서 6개월 거주 필요 (1학년 2학기~2학년 1학기)',
    detail: `<p>아산 소재학교 재학 중 천안이 거주지인 상태에서 천안 소재학교로 전학하려는 경우입니다.</p>
      <ul>
  ...
  T7: {
    ...
    label: '조건부 가능',
    icon: '⚠',
    title: '천안 전학 — 전 가족이 아산에서 6개월 거주 필요 (1학년 2학기~2학년 1학기)',
    detail: `<p>천안 소재학교 재학 중 아산이 거주지인 상태에서 아산 소재학교로 전학하려는 경우입니다.</p>
      <ul>
        <li>현 학교 소재지에서 <strong>6개월 이상 거주</strong> 조건 필요</li>
        <li>신청 가능 시기: 1학년 2학기 ~ 2학년 1학기</li>
      </ul>`
  ...
  T11: {
    ...
    icon: '✕',
    title: '타시도 교육청으로 문의',
    detail: `<p>전 가족(부,모,자녀)의 거주지가 아산에서 천안으로 이전되고 부모님이 세대주가 되셔야 전학이 가능합니다.</p>`      
  },
  T12: {
    badge: 'inquiry',
    label: '문의 필요',
    icon: '?',
    title: '해당 지역 교육청 문의',
    detail: `<p>충남 외 타시도에서 충남 외 타시도로 이동하시는 경우 이사하시는 해당 타시도 교육청으로 문의하여 주시기 바랍니다.</p>
      <ul>       
        <li>특성화고는 해당 학교에 별도 문의 필요</li>
      </ul>`
  },
  ...
  T14: {
    ...
    icon: '✕',
    title: '거주지 이전 필요',
    detail: `<p>재학 중인 학교가 소재한 지역에서 전 가족(부,모,자녀)가 천안으로 이사해야 전학이 가능합니다.일반고 재학시 1년, 특성화고 재학시 6개월 거주 필요</p>
      <ul>
        <li>전 가족 이사 및 세대주 조건 충족 필요</li>
        <li>특성화고는 해당 학교에 별도 문의 필요</li>       
      </ul>`
  },
  T15: {
    ...
    icon: '✕',
    title: '거주지 이전 필요',
    detail: `<p>재학 중인 학교가 소재한 지역에서 전 가족(부,모,자녀)가 아산으로 이사해야 전학이 가능합니다.일반고 재학시 1년, 특성화고 재학시 6개월 거주 필요</p>
      <ul>
        <li>전 가족 이사 및 세대주 조건 충족 필요</li>
        <li>특성화고는 해당 학교에 별도 문의 필요</li>       
      </ul>`
  ...
  T18: {
    ...
    detail: `<p>현 학교 소재지에서 1년 이상 거주한 경우 천안으로의 전학이 가능합니다.</p>
      <p>희망학교가 특성화고등학교인 경우 2학년 1학기까지 전학이 가능합니다.</p>`
  }
};
